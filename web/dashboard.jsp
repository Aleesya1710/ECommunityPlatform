    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="flex items-center space-x-4">
                <% if (userId == null) { %>
                    <a id="login" href="login.jsp" class="btn-primary px-5 py-2 text-sm font-bold rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 uppercase">
                        LOGIN
                    </a>
                <% } else { %>
                    <span class="text-text-dark font-semibold hidden md:inline">Welcome, <%= userName != null ? userName : "User" %>!</span>
                    <a href="logout.jsp" class="btn-primary px-5 py-2 text-sm font-bold rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 uppercase">
                        LOGOUT
                    </a>
                <% } %>
